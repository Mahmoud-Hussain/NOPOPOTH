...
<head>
    ...
    <title>Employer Dashboard - Nobopoth</title>
    <!-- Favicon -->
...
<body>
    ...
    <div id="mySidenav" class="sidenav" name="sidebar">
        ...
        <a href="#" name="pending-orders-link">Pending Applications</a>
    ...
    <nav class="navbar" name="navbar">
        <div class="welcome" name="welcome-message">Welcome, [Employer Name]</div>
    ...
    <div class="main-content" id="main" name="main-content">
        ...
        <!-- Posted Jobs and Messages -->
        <div class="jobs-messages-container" name="jobs-messages-container">
            <!-- Posted Jobs -->
            <section class="popular-jobs" name="posted-jobs-section">
                <h2 name="posted-jobs-title">Posted Jobs</h2>
    ...
    <div class="fab" name="fab-post-job">
        <i class="fas fa-plus"></i>
    </div>
    <!-- Pending Jobs Popup -->
<div class="pending-jobs-popup" id="pendingJobsPopup" name="pending-jobs-popup">
    <div class="pending-jobs-header" name="pending-jobs-header">
        <h3 name="pending-jobs-title">Pending Jobs</h3>
        <span class="close-btn" onclick="closePendingJobsPopup()" name="pending-jobs-close-btn">×</span>
    </div>
    <div class="pending-jobs-content" name="pending-jobs-content">
        <div class="pending-jobs-list" name="pending-jobs-list">
            <div class="pending-job-item" name="pending-job-item-1">
                <h3 name="pending-job-title-1">Web Developer</h3>
                <p name="pending-job-description-1">Looking for a skilled web developer to build a responsive website.</p>
                <p name="pending-job-applicants-1"><strong>Applicants:</strong> 5</p>
            </div>
            <div class="pending-job-item" name="pending-job-item-2">
                <h3 name="pending-job-title-2">Graphic Designer</h3>
                <p name="pending-job-description-2">Need a graphic designer for logo and branding.</p>
                <p name="pending-job-applicants-2"><strong>Applicants:</strong> 3</p>
            </div>
            <div class="pending-job-item" name="pending-job-item-3">
                <h3 name="pending-job-title-3">Content Writer</h3>
                <p name="pending-job-description-3">Hiring a content writer for blog posts and articles.</p>
                <p name="pending-job-applicants-3"><strong>Applicants:</strong> 2</p>
            </div>
        </div>
    </div>
</div>
...
<div class="overlay" id="overlay"></div>
    <!-- JavaScript -->
    <script src="Employer.js" name="admin-script"></script>
</body>
</html>